...
interface WeightRepository {
    ...
    suspend fun saveWeight(userId: String, request: SaveWeightRequest, overwrite: Boolean): Result<WeightRecordItem>
    suspend fun updateWeight(recordId: String, weightKg: Double, note: String?): Result<WeightRecordItem>
